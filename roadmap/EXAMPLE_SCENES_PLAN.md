...
> Dependencies: `sus-core`, `downstream library`  
> Status: 🔵 Planning
...
| Whale example (standard) | `downstream library/Samples~/BasicKit/` | ✅ Done |
...
public class ExampleName : MonoBehaviour
{
    ...
    private void BuildUI()
    {
        ...
        // 1. Token cascade (sus-core + downstream library tokens)
...
All screens inside the examples use `downstream library` components:```csharp
...
"description": "SusModal from downstream library + Fade/Slide animation",
        "path": "Samples~/Modals"
    },
    {
...
"description": "ALL router features + maximum downstream library components in one example",
